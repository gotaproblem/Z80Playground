...
;cpm_fileroot: db "/CPM", 0
;cpm_filepath: db "DISKS", 0
;cpm_default_disk: db "/CPM/A.DSK", 0
...
dir:
    ...
    ;ld hl, cpm_fileroot                    ; Start at /CPM
    ;call open_file
    ;ld hl, cpm_filepath                    ; Then DISKS
    ;call open_file
